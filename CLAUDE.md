...
├── covenants.html           # Заветы (~640 строк, только HTML-контент)
├── css/
...
│   └── covenants.css         # Цвета заветов, структура завета (~70 строк)
├── js/
...
### Навигация covenants.html — 6 вкладок

1. **Ноев** — 2 карточки (благословение и повеление, завет и радуга)
2. **Авраамов** — 3 карточки (призвание, завет рассечения, завет обрезания)
3. **Синайский** — 4 карточки (богоявление, Десять заповедей, Книга завета и ратификация, обновление)
4. **Моавитский** — 3 карточки (благословения, проклятия, завет в Моаве и призыв к жизни)
5. **Сравнение** — сортируемая таблица 4 заветов
6. **Принципы** — 8 богословских принципов заветной системы
...
### Заветы (`css/covenants.css`)

| Категория | CSS-переменная | Цвет |
|-----------|---------------|------|
| Ноев | `--noah` | `#2980b9` голубой |
| Авраамов | `--abraham` | `#b8860b` золотой |
| Синайский | `--sinai` | `#c0392b` красный |
| Моавитский | `--moab` | `#27ae60` зелёный |
